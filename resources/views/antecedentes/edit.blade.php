...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Editar Antecedente</li>
@endsection
@section('content')
<div class="row justify-content-center">
<div class="col-xl-9">
<div class="card">
    <div class="card-header py-3">Editar Antecedente</div>
    <div class="card-body">
    <form method="POST" action="{{ route('personas.antecedentes.update', [$persona, $registro]) }}" enctype="multipart/form-data">
        @csrf @method('PUT')
        <div class="row g-3">
            <div class="col-md-4">
