    ...
    <div style="width:100%;max-width:420px;" class="px-3">
        <div class="card auth-card border-0">
            <div class="auth-brand">
                ...
                <p class="mb-0 opacity-75" style="font-size:.85rem;"><?php echo e(config('app.name')); ?></p>
            </div>
...
<?php /**PATH D:\Proyectos\CvsManager\resources\views/layouts/auth.blade.php ENDPATH**/ ?>