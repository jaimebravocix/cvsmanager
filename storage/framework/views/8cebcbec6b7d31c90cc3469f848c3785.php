...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CV Docente'); ?> - <?php echo e(config('app.name')); ?></title>
...
<nav id="sidebar">
    ...
    <ul class="nav flex-column py-2">
        ...
        <li class="nav-item">
            <a href="<?php echo e(route('personas.show', auth()->user()->persona)); ?>" class="nav-link">
    ...
    <div class="p-3 mt-auto" style="border-top:1px solid rgba(255,255,255,.08)">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                <div style="color:#fff;font-size:.82rem;font-weight:500;"><?php echo e(auth()->user()->name); ?></div>
...
<div id="main-content">
    <div class="topbar d-flex align-items-center justify-content-between">
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>" class="d-flex align-items-center gap-2">
            <?php echo csrf_field(); ?>
            <span class="text-muted small d-none d-md-inline"><?php echo e(auth()->user()->email); ?></span>
...
<?php /**PATH D:\Proyectos\CvsManager\resources\views/layouts/app.blade.php ENDPATH**/ ?>